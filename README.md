...
![](https://imgkr.cn-bj.ufileos.com/701d2bc4-22a6-410f-a8ba-465c45d5ad54.png)
...
>已经把项目放到 **github**：https://github.com/Sunny-lucking/howToBuildMyVuex  可以卑微地要个star吗
...
5. 如果判断当前组件是子组件的话，就将我们根组件的$store也复制给子组件。注意是**引用的复制**，因此每个组件都拥有了同一个$store挂载在它身上。
